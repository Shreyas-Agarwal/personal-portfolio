        ...
        <div data-header-theme="light" className="min-h-screen bg-[#F3F1EC] text-[#1a1a1a] selection:bg-black/10">
                    ...
                    <div className="space-y-6">
                        <div className="space-y-4">
                            ...
                            <p className="max-w-2xl text-xl leading-relaxed text-neutral-600">
                                An archive of systems thinking, architectural reflections, and technical observations.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <main className="mx-auto max-w-4xl px-6 py-24 md:px-12">
                <div className="space-y-16">
                    {notes.map((note) => (
                        <article key={note.slug} className="group relative flex flex-col items-start justify-between border-l-2 border-neutral-200 pl-6 transition-colors hover:border-black md:flex-row md:items-center">
                            <div className="flex-1 space-y-4">
                                ...
                                <div>
                                    ...
                                    {note.subtitle && (
                                        <p className="mt-2 text-lg text-neutral-600 line-clamp-2">
                                            {note.subtitle}
                                        </p>
                                    )}
                                </div>
                                ...
                                {note.tags && note.tags.length > 0 && (
                                    <div className="flex flex-wrap gap-2 pt-2">
                                        {note.tags.map((tag) => (
                                            <span key={tag} className="flex items-center gap-1 text-[11px] font-medium text-neutral-400">
