...
import { ArrowLeft, Clock, Tag, Github } from "lucide-react";
                            ...
                            {data.tags && (
                                <div className="flex flex-wrap gap-2">
                                    {Array.isArray(data.tags) ? data.tags.map((tag: string) => (
                                        <span key={tag} className="flex items-center gap-1 text-[11px] font-medium text-neutral-500">
            ...
            <main className="mx-auto max-w-4xl px-6 py-24 md:px-12">
                ...
                <footer className="mt-32 border-t border-neutral-200 pt-12 text-center">
                    <p className="text-sm text-neutral-400">
                        &copy; {new Date().getFullYear()} Shreyas Agarwal. Systems Documentation.
                    </p>
                </footer>
            </main>
        </div>
