...
export default function UnderReviewPage() {
  return (
    <div
      ...
      className="flex min-h-screen items-center justify-center bg-[#F3F1EC] text-[#1a1a1a] selection:bg-black/10 px-6 py-24 md:px-12"
    >
      <main className="w-full max-w-2xl text-center">
        ...
        <p className="mx-auto mb-12 max-w-lg text-lg leading-relaxed text-neutral-600">
          The technical documentation for this architecture is currently being formalized and
          reviewed. This process ensures high-fidelity representation of the operational system.
