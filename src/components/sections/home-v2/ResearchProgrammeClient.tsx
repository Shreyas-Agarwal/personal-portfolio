  ...
  return (
    <svg viewBox="0 0 320 60" className="w-full max-w-sm h-auto select-none mt-6">
      ...
      <text
        ...
        className={`${plexMono.className} text-[9px] fill-[#E6E1D6]/40 uppercase tracking-[0.2em]`}
      >
        Build
      </text>
      <line
      ...
      <text
        ...
        textAnchor="middle"
        dominantBaseline="middle"
        className={`${plexMono.className} text-[9px] fill-[#DE4B31] font-semibold uppercase tracking-[0.2em]`}
      >
        Generalise
      </text>
...
export function ResearchProgrammeClient({ essays }: ResearchProgrammeClientProps) {
  const [hoveredTrack, setHoveredTrack] = useState<"architecture" | "physics" | "laws">(
    "architecture",
  );
  const [mobileTrack, setMobileTrack] = useState<"architecture" | "physics" | "laws" | null>(
    "architecture",
  );
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-[1fr_220px] mb-16 pb-8 border-b border-[#E6E1D6]/10">
          ...
          <div className="flex items-center">
            <div
              className={`${plexMono.className} space-y-2.5 text-[11px] tracking-wide text-[#E6E1D6]/35`}
            >
              <div>
                <span className="block text-[8px] uppercase tracking-[0.15em] text-[#E6E1D6]/20 mb-0.5">
                  TYPE
                </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <div className="max-w-2xl space-y-6">
              <h3
                className={`${serif.className} text-xl md:text-2xl italic leading-relaxed text-[#E6E1D6]/85`}
              >
                “Every production system eventually teaches the same lessons. Writing is how I check
                whether those lessons actually generalise.”
              </h3>
              <p
                className={`${serif.className} text-base md:text-lg leading-relaxed text-[#E6E1D6]/70`}
              >
                The software projects are experiments. The writing attempts to extract the reusable
                engineering principles hiding underneath those projects. The goal is not
                documentation; it is building a vocabulary for understanding information systems.
              </p>
            </div>
            ...
            <div className="hidden lg:block space-y-4 pt-4 max-w-2xl">
              <span
                className={`${plexMono.className} block text-[9px] uppercase tracking-wider text-[#E6E1D6]/35 mb-2`}
              >
              ...
              <div className="space-y-4">
                {(
                  [
                    ...
                    {
                      id: "laws",
                      title: "Laws of Information Systems",
                  ...
                  >
                    <div className="flex justify-between items-baseline">
                      ...
                      <span
                        className={`${plexMono.className} text-[8px] uppercase tracking-wider text-[#E6E1D6]/45`}
                      >
                        {track.status}
                      </span>
                    </div>
            ...
            <div className="lg:hidden mt-8 space-y-6">
              ...
              <div className="border border-[#E6E1D6]/10 p-5 bg-[#E6E1D6]/[0.02] rounded-sm">
                <div
                  ...
                  onClick={() =>
                    setMobileTrack(mobileTrack === "architecture" ? null : "architecture")
                  }
                >
                  ...
                  {mobileTrack === "architecture" && (
                    ...
                    >
                      ...
                      <p className={`${plexMono.className} text-[10px]`}>
                        <strong>Focus:</strong> modelling, state, events, storage, computation,
              ...
              <div className="border border-[#E6E1D6]/10 p-5 bg-[#E6E1D6]/[0.02] rounded-sm">
                <div
                  className="flex justify-between items-center cursor-pointer"
                  onClick={() => setMobileTrack(mobileTrack === "physics" ? null : "physics")}
                >
                  <span
                ...
                <AnimatePresence>
                  {mobileTrack === "physics" && (
                    ...
                    >
                      <p className={`${serif.className}`}>
                        <strong>Question:</strong> What behaviours consistently emerge once
                        information begins moving through complex systems?
                      </p>
                      <p className={`${plexMono.className} text-[10px]`}>
                        <strong>Focus:</strong> emergence, coordination, propagation, bottlenecks,
                        temporal behaviour, scaling pressure
                      </p>
                    </motion.div>
                  )}
                </AnimatePresence>
              ...
              <div className="border border-[#E6E1D6]/10 p-5 bg-[#E6E1D6]/[0.02] rounded-sm">
                <div
                  className="flex justify-between items-center cursor-pointer"
                  onClick={() => setMobileTrack(mobileTrack === "laws" ? null : "laws")}
                >
                  <span
                    className={`${plexMono.className} text-xs text-[#E6E1D6]/60 tracking-wider`}
                  >
                ...
                <AnimatePresence>
                  {mobileTrack === "laws" && (
                    ...
                    >
                      <p className={`${serif.className}`}>
                        <strong>Question:</strong> Are there engineering principles that remain true
                        regardless of language, framework, or implementation?
                      </p>
                      <p className={`${plexMono.className} text-[10px] space-y-1`}>
                        <strong>Examples:</strong>
                        <br />· information always decays
                        <br />· coordination has cost
                        <br />· state must exist somewhere
                        <br />· locality dominates latency
                      </p>
                    </motion.div>
                  )}
                </AnimatePresence>
            ...
            {essays.length > 0 && (
              <div className="space-y-6 border-t border-[#E6E1D6]/10 pt-8 mt-12 max-w-2xl">
                <span
                  className={`${plexMono.className} block text-[9px] uppercase tracking-wider text-[#E6E1D6]/35`}
                >
                  SELECTED WORKS
                </span>
                  ...
                  {essays.map((essay) => (
                    ...
                    >
                      <div className="flex flex-col md:flex-row md:items-baseline md:justify-between gap-1 mb-2">
                        <span
                          className={`${serif.className} text-xl italic text-[#E6E1D6]/90 group-hover:text-[#DE4B31] transition-colors`}
                        >
                          {essay.title}
                        </span>
                        <span
                          className={`${plexMono.className} text-[9px] text-[#E6E1D6]/45 uppercase tracking-widest`}
                        >
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p
                          className={`${serif.className} text-xs text-[#E6E1D6]/70 leading-relaxed mt-1`}
                        >
                      ...
                      <div>
                        ...
                        <div
                          className={`${plexMono.className} text-[11px] text-[#E6E1D6]/80 mt-1.5 flex flex-wrap gap-1.5`}
                        >
                          {[
                            "modelling",
                            "state",
                            ...
                            <span
                              key={f}
                              className="border border-[#E6E1D6]/10 px-2 py-0.5 text-[9px] rounded-sm bg-[#E6E1D6]/5"
                            >
                              {f}
                            </span>
                          ))}
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p
                          className={`${serif.className} text-xs text-[#E6E1D6]/70 leading-relaxed mt-1`}
                        >
                          What behaviours consistently emerge once information begins moving through
                          complex systems?
                        </p>
                      </div>
                      <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p
                          className={`${serif.className} text-xs text-[#E6E1D6]/70 leading-relaxed mt-1`}
                        >
                          Are there engineering principles that remain true regardless of language,
                      ...
                      <div>
                        ...
                        <div
                          className={`${plexMono.className} text-[11px] text-[#E6E1D6]/80 mt-1.5 flex flex-col gap-2`}
                        >
                          {[
