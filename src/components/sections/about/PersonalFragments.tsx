        ...
        <div className="grid gap-6 md:grid-cols-12">
          ...
          <div className="space-y-6 md:col-span-5">
            {fragments.slice(1, 3).map((item) => (
              ...
              >
                <div
                  className={`absolute right-0 top-0 h-24 w-24 rounded-full ${item.accent}/10 blur-2xl`}
                />
                ...
                <div className="relative">
                  ...
                  <p className="mt-6 text-sm leading-relaxed text-black/52">{item.description}</p>
                </div>
              </div>
            ))}
          </div>
