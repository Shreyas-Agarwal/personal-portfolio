...
const fragments = ["SYSTEMS", "PHILOSOPHY", "FANTASY", "COORDINATION", "WORLDBUILDING", "MOVEMENT"];

export function AboutHero() {
  return (
    <section
      data-header-theme="light"
      className="relative overflow-hidden bg-[#EAE6DF] px-6 pt-32 pb-24 md:px-12"
    >
          ...
          <div className="max-w-4xl">
            ...
            <div className="mt-10 max-w-2xl space-y-6">
              <p className="text-xl font-light leading-relaxed text-black/65">
                Outside operational systems and architectural thinking, I am deeply interested in
                philosophy, fiction, movement, narrative structures, exploration, and the way people
                coordinate around ideas.
              </p>

              <p className="max-w-xl text-sm leading-relaxed text-black/45">
                The same curiosity that drives my interest in information flow and organizational
                systems also appears in fantasy worlds, process philosophy, travel, dance, and the
                strange ways humans create meaning collectively.
              </p>
            </div>
          ...
          <div className="flex flex-col justify-between">
            ...
            <div className="mt-24 rounded-[28px] border border-black/[0.08] bg-white/40 p-8 backdrop-blur-sm">
              ...
              <p className="text-lg font-light leading-relaxed text-black/68">
                I am less interested in mastering a single discipline, and more interested in
                understanding how seemingly unrelated systems — technical, human, philosophical, or
                fictional — begin to mirror each other under enough complexity.
              </p>
            </div>
          </div>
        </div>
