        ...
        <div className="mb-28 grid gap-12 md:grid-cols-[1fr_380px] md:items-end">
          ...
          <div className="max-w-sm">
            <p className="text-sm leading-relaxed text-black/50">
              These systems emerged through real coordination pressure, workflow complexity,
              operational scaling, and architectural tradeoffs across evolving product
              infrastructure.
            </p>
          </div>
        </div>
              ...
              <div className="grid gap-10 px-8 py-14 md:grid-cols-[180px_1fr_280px] md:px-12">
                ...
                <div className="max-w-3xl">
                  ...
                  <div className="mt-12 grid gap-10 md:grid-cols-2">
                    <div>
                      ...
                      <p className="text-sm leading-relaxed text-black/50">{item.pressure}</p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-sm leading-relaxed text-black/50">{item.response}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="hidden border-l border-black/[0.06] pl-8 md:block">
                  ...
                  <p className="text-sm leading-relaxed text-black/40">
                    The resulting architecture represents a response to coordination pressure,
                    operational complexity, and scaling constraints rather than purely technical
                    preference.
                  </p>
                </div>
              </div>
          ...
          <div className="grid gap-12 md:grid-cols-[1fr_420px]">
            ...
            <div className="max-w-3xl">
              ...
              <p className="text-lg font-light leading-relaxed text-black/62">
                Architectural decisions were documented not as static technical documentation, but
                as operational reasoning records — preserving tradeoffs, constraints, and the
                evolution of system thinking over time.
              </p>
            </div>
