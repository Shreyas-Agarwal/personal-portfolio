...
export function SystemsHero() {
    return (
        <section data-header-theme="dark" className="relative overflow-hidden bg-[#0A0F14] px-6 pt-32 pb-24 md:px-12">
            {/* Structural Grid */}
                    ...
                    <div className="max-w-4xl">
                        ...
                        <div className="mt-10 max-w-2xl space-y-6">
                            <p className="text-xl font-light leading-relaxed text-white/62">
                                Most architectures do not begin as complex systems. Complexity
                                emerges gradually through coordination requirements, workflow
                                scaling, distributed execution, and accumulated operational
                                constraints.
                            </p>

                            <p className="max-w-xl text-sm leading-relaxed text-white/38">
                                This archive documents how information systems evolve under real
                                operational conditions — from structured workflows and audit
                                systems to orchestration layers, governance boundaries, and
                    ...
                    <div className="flex flex-col justify-between">
                        ...
                        <div className="mt-20 border-l border-white/[0.08] pl-6">
                            ...
                            <p className="max-w-sm text-sm leading-relaxed text-white/42">
                                Architectural complexity is rarely introduced intentionally.
                                Most systems accumulate complexity as operational coordination
                                expands across teams, workflows, and information boundaries.
                            </p>
                        </div>
                    </div>
                </div>
