        ...
        <div className="mt-28 border-t border-white/[0.06] pt-10">
          <div className="max-w-4xl">
            ...
            <p className="mt-5 text-lg font-light leading-relaxed text-white/60">
              enterprise operational environments should remain executionally isolated while still
              participating in a centralized coordination and governance model.
            </p>
            ...
            <p className="mt-5 text-lg font-light leading-relaxed text-white/60">
              ...
              <span className="text-white/90">
                {" "}
                It was preserving coherent operational flow across independently evolving systems.
              </span>
            </p>
          </div>
        </div>
