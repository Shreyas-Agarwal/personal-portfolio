...
import { Database, KeyRound, Network, Server, ShieldCheck, Workflow } from "lucide-react";
  ...
  return (
    <div className="rounded-[32px] border border-blue-500/10 bg-blue-500/[0.03] p-8">
      ...
      <div className="mt-10 space-y-4">
        <ServiceRow icon={<KeyRound size={16} />} label="Authentication" />

        <ServiceRow icon={<ShieldCheck size={16} />} label="RBAC & Permissions" />

        <ServiceRow icon={<Network size={16} />} label="Tenant Governance" />

        <ServiceRow icon={<Server size={16} />} label="Licensing Services" />

        <ServiceRow icon={<Workflow size={16} />} label="Platform APIs" />
      </div>
      ...
      <div className="mt-8 rounded-3xl border border-white/[0.06] bg-black/20 p-5">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h4 className="text-sm font-medium text-white/90">Platform Database</h4>
