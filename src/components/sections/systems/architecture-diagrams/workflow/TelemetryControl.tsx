...
import { Activity, ShieldAlert, Settings2, Gauge, Terminal } from "lucide-react";
                ...
                <div className="grid gap-6 md:grid-cols-2">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-3 px-2">
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-widest text-blue-400/60">Real-time Telemetry</span>
                        </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-3 px-2">
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-widest text-emerald-400/60">Policy Injection</span>
                        </div>
...
function ControlCard({ 
    ...
    return (
        <div className="rounded-2xl border border-white/[0.06] bg-black/20 p-5 flex items-start gap-4 hover:border-white/10 transition-colors">
            <div className={`mt-1 rounded-lg p-2 bg-white/[0.03] ${highlight === "blue" ? "text-blue-400/70" : "text-emerald-400/70"}`}>
                {icon}
            </div>
            <div>
