...
import { Activity, Boxes, Cpu, Database, MessageSquare, Server, Workflow } from "lucide-react";
      ...
      <div className="grid gap-10 xl:grid-cols-2">
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-3 px-2 mb-2">
            ...
            <h5 className="font-mono text-[11px] tracking-wider text-white/40 uppercase">
    ...
    >
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="md:w-48">
          ...
          >
            <Database
              className={`mx-auto mb-3 ${accent === "blue" ? "text-blue-400" : "text-emerald-400"}`}
              size={24}
            />
            ...
            <div className="mt-4 flex justify-center">
              <div
                className={`h-1 w-12 rounded-full ${accent === "blue" ? "bg-blue-500/40" : "bg-emerald-500/40"}`}
              />
            </div>
          </div>
