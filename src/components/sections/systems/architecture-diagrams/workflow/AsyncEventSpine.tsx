...
import { Webhook, MessageSquare, Layers3, Cpu } from "lucide-react";
import { MiniService, HorizontalFlow, DistributionNode } from "./SharedComponents";
        ...
        >
            <div className="mb-10 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
                ...
                <p className="max-w-md text-sm leading-relaxed text-white/40">
                    Incoming webhook traffic was normalized,
                    enriched with metadata, and distributed
                    through broadcast or directed delivery
                    channels depending on routing semantics.
                </p>
            </div>
            ...
            <div className="grid gap-8 xl:grid-cols-[1fr_120px_1fr_120px_1fr]">
                ...
                <div className="flex items-center justify-center">
                    <div className="w-full rounded-2xl border border-white/[0.08] bg-black/30 p-6 text-center">
                        ...
                        <p className="mt-2 text-sm leading-relaxed text-white/40">
                            Metadata enrichment, routing logic,
                            event normalization, orchestration.
                        </p>
                    </div>
                </div>
                ...
                <div className="grid gap-4">
                    <DistributionNode
                        title="SNS Fanout"
                        subtitle="Broadcast delivery to multiple clusters"
                    />

                    <DistributionNode
                        title="SQS Queues"
                        subtitle="Directed tenant-specific routing"
                    />
                </div>
            </div>
        </motion.div>
