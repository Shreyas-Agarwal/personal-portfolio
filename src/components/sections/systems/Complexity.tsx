                ...
                <div className="mb-28 grid gap-16 md:grid-cols-[1fr_420px] md:items-end">
                    ...
                    <div className="max-w-md">
                        <p className="text-sm leading-relaxed text-white/42">
                            Systems rarely transition from monoliths to distributed
                            architectures intentionally. Most architectural shifts emerge from
                            scaling coordination requirements, workflow complexity, team
                            boundaries, and operational visibility constraints.
                        </p>
                    </div>
                </div>
                        ...
                        {evolution.map((item, index) => (
                            ...
                            >
                                ...
                                <div className="border-l border-white/[0.05] pl-6">
                                    ...
                                    <p className="text-sm leading-relaxed text-white/34">
                                        {item.observation}
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="flex flex-col gap-10 md:flex-row md:items-end md:justify-between">
                        ...
                        <div className="max-w-3xl">
                            ...
                            <p className="mt-4 text-lg font-light leading-relaxed text-white/38">
                                Most architectures simply redistribute coordination pressure
                                across new operational boundaries.
                            </p>
                        </div>
