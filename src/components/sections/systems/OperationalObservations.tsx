        ...
        <div className="mb-24 grid gap-12 md:grid-cols-[1fr_380px] md:items-end">
          ...
          <div className="max-w-sm">
            <p className="text-sm leading-relaxed text-white/42">
              The most valuable architectural lessons rarely emerge during implementation. They
              emerge later — through scaling pressure, operational friction, coordination failure,
            ...
            >
              ...
              <div className="hidden border-l border-white/[0.05] pl-8 md:block">
                ...
                <p className="text-sm leading-relaxed text-white/30">
                  Architectural maturity often comes less from technical sophistication, and more
                  from understanding how operational systems behave under real coordination
                  pressure.
                </p>
              </div>
            </div>
          ...
          <div className="grid gap-16 md:grid-cols-[1fr_320px]">
            ...
            <div className="max-w-4xl">
              ...
              <p className="mt-6 text-2xl font-light leading-relaxed tracking-tight text-white/38 md:text-3xl">
                And the more it feels like designing for coordination, visibility, operational
                clarity, and organizational memory.
              </p>
            </div>
            ...
            <div className="border-l border-white/[0.05] pl-8">
              ...
              <p className="text-sm leading-relaxed text-white/30">
                Current exploration areas include workflow orchestration, operational
                infrastructure, distributed coordination systems, architectural governance, and
