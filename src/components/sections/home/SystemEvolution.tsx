...
export function SystemEvolutionPreview() {
    return (
        <section data-header-theme="dark" className="relative overflow-hidden border-t border-white/[0.06] bg-[#0B0D10] px-6 py-28 md:px-12">
            {/* Structural Grid */}
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-sm leading-relaxed text-white/50">
                            Most systems begin as isolated operational tools. Over time,
                            coordination pressure introduces workflows, state management,
                            distributed execution, and eventually governance constraints.
                        </p>

                        <p className="text-sm leading-relaxed text-white/40">
                            My architectural thinking emerged through observing how these
                            layers evolve under real operational conditions.
                        </p>
                    </div>
                ...
                <div className="relative">
                    ...
                    <div className="space-y-14">
                        {evolution.map((item) => (
                            <div
                                key={item.stage}
                                className="relative grid gap-6 pl-10 md:grid-cols-[80px_1fr]"
                            >
                                {/* Node */}
