...
export function OperationalIntelligenceSection() {
    return (
        <section data-header-theme="dark" className="relative overflow-hidden bg-[#0B0D10] px-6 py-32 md:px-12">
            {/* Structural Rules */}
                ...
                <div className="mb-24 grid gap-12 md:grid-cols-[1.2fr_0.8fr] md:items-end">
                    ...
                    <div className="max-w-md">
                        <p className="text-sm leading-relaxed text-white/45">
                            Analytical exploration created the foundation. Operational systems,
                            coordination pressure, and information flow transformed that
                            foundation into architectural thinking.
                        </p>
                    </div>
                </div>
                ...
                <div className="mt-32 border-t border-white/[0.06] pt-10">
                    <div className="max-w-3xl">
                        ...
                        <p className="mt-4 text-lg font-light leading-relaxed text-white/60">
                            ...
                            <span className="text-white/90">
                                {" "}
                                “How do systems preserve meaning, coordination, and operational
                                clarity as complexity scales?”
                            </span>
                        </p>
                    </div>
                </div>
