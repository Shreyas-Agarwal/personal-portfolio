...
The industry spent decades optimizing storage and computation. Increasingly, the bottleneck is neither. The bottleneck is the cost of moving information between them. And that is where we go next.
