  ...
  async redirects() {
    return [
      // Legacy journal URLs -> new Architecture of Information Systems publication
      {
        ...
        destination: "/projects/publications/architecture-of-information-systems/data/oltp-vs-olap",
        permanent: true,
      },
      {
      ...
      },
      {
        ...
        destination: "/projects/publications/architecture-of-information-systems/data/random-uuids",
        permanent: true,
      },
      {
